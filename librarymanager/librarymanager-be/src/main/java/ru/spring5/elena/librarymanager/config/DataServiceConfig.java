package ru.spring5.elena.librarymanager.config;
...
@Configuration
@ComponentScan("ru.spring5.elena.librarymanager")
...
public class DataServiceConfig {
    ...
    public EntityManagerFactory entityManagerFactory(
        ...
        factoryBean.setPackagesToScan("ru.spring5.elena.librarymanager.domain.entities");
